...
The [functionname function](`franklin.modulename.functionname`) does ... [](`franklin.modulename.functionname`) does ... [](`~franklin.modulename.functionname`) does ...
...
![](images/elephant.png){#fig-surus}

![](images/elephant.png){#fig-hanno}
